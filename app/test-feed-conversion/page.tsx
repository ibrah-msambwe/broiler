...
export default function TestFeedConversion() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold">⚖️ Test Feed Conversion & Weight</h1>
        <p className="text-muted-foreground">
          Test that feed conversion ratio, current weight, and vaccinations are calculated from reports
        </p>
      </div>
                ...
                {batches.map((batch) => (
                  <div key={batch.id} className="p-4 border rounded-lg">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm mt-3">
                      <div className="text-center">
                        <div className="font-medium text-purple-600">{batch.feedConversionRatio?.toFixed(2) || 0}</div>
                        <div className="text-xs text-muted-foreground">Feed Conversion</div>
                      </div>
                      <div className="text-center">
                        <div className="font-medium text-orange-600">{batch.currentWeight?.toFixed(1) || 0}kg</div>
                    ...
                    <div className="mt-2 text-xs text-muted-foreground">
                      Processed {batch.totalReports} reports • Feed Used: {batch.feedUsed?.toFixed(1) || 0}kg • Total Weight: {batch.totalWeight?.toFixed(1) || 0}kg
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={testReport.reportType} onValueChange={(value) => setTestReport({...testReport, reportType: value})}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="weight">Weight Report</SelectItem>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2 text-sm">
            <div>✅ <strong>Feed Conversion Ratio:</strong> Calculated as Total Feed Used ÷ (Current Weight × Remaining Birds)</div>
            <div>✅ <strong>Current Weight:</strong> Latest weight from reports or average of all weight readings</div>
            <div>✅ <strong>Vaccinations:</strong> Sum of all vaccination counts from reports</div>
